...
import Neoplasm1m from "./Neoplasm1";
import Neoplasm2m from "./Neoplasm2";
...
export const Alphabetneo1m = ({ setSelectedCode }) => {
              ...
              <Box sx={{ width: "100%" }}>
                ...
                >
                  ...
                  <CustomTabPanel value={value} index={0}>
                    <Neoplasm1m onCodeClick={setSelectedCode} />
                  </CustomTabPanel>
                  <CustomTabPanel value={value} index={1}>
                    <Neoplasm2m onCodeClick={setSelectedCode} />
                  </CustomTabPanel>
